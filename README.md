...
[![CI](https://github.com/mnfst/manifest-python/actions/workflows/ci.yml/badge.svg?branch=feat/manifest-python-sdk)](https://github.com/mnfst/manifest-python/actions/workflows/ci.yml)
...
Requires **Python 3.10+**. This preview is not published to PyPI yet; install the SDK branch with GitHub access:

```sh
python -m venv .venv
source .venv/bin/activate
python -m pip install 'git+https://github.com/mnfst/manifest-python.git@feat/manifest-python-sdk'
```
